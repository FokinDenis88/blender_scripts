...
PARENT_DIR = os.path.join(os.path.join(os.path.join(WORKING_DIR, os.pardir), os.pardir), os.pardir)
...
def get_TextureTypesCustom_prefix_suffix_list(texture_type):
    ...
    if general.is_not_none_or_empty(texture_type):
        ...
        print(get_TextureTypesCustom_prefix_suffix_list.__name__ + '() Error: texture_type must not be None or Empty')
